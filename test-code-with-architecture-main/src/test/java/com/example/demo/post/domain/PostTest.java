...
public class PostTest {
    ...
    public void PostCreate로_게시물을_만들_수_있다() {
        ...
        // when
        Post post = Post.from(writer, postCreate, new TestClockHolder(1978530673958L));

        // then
        assertThat(post.getContent()).isEqualTo("helloworld");
        assertThat(post.getCreatedAt()).isEqualTo(1978530673958L);
    ...
    public void PostUpdate로_게시물을_수정할_수_있다() {
        ...
        Post post = Post.builder()
                .id(1L)
                .content("helloworld")
                .createdAt(1978530673958L)
                .modifiedAt(0L)
                .writer(writer)
                .build();

        // when
        post = post.update(postUpdate, new TestClockHolder(1978530673958L));
