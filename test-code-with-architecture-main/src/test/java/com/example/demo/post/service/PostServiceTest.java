...
public class PostServiceTest {
    ...
    void init() {
        ...
        this.postService = PostService.builder()
                ...
                .clockHolder(new TestClockHolder(1978530673958L))
                .build();
    ...
    void postCreate_를_이용하여_게시물을_생성할_수_있다() {
        ...
        assertThat(result.getCreatedAt()).isEqualTo(1978530673958L);
    }
    ...
    void postUpdate_를_이용하여_게시물을_수정할_수_있다() {
        ...
        assertThat(post.getModifiedAt()).isEqualTo(1978530673958L);
    }
