...
class CalculationRequestTest {
    ...
    @Test
    public void 유효한_숫자를_파싱할_수_있다() throws Exception {
        // given
    ...
    @Test
    public void 세자리_숫자가_넘어가는_유효한_숫자를_파싱할_수_있다() throws Exception {
        // given
    ...
    @Test
    public void 유효한_길이의_숫자가_들어오지_않으면_에러를_던진다() throws Exception {
        // given
    ...
    @Test
    public void 유효하지_않은_연산자가_들어오면_에러를_던진다() throws Exception {
        // given
